...
- CONN-REQ-044: Strict test는 시스템 신뢰 CA를 명시한 TLS `verify-full`, connect 5초, statement 3초, API 10초, distributed lease 30초, 요청당 한 번의 connection attempt, read-only `SELECT 1`과 one-row scalar result를 적용해야 한다.
